...
UKF::UKF() {
  ...
  std_a_ = 0.30; //TODO: necessita ajustes

  // Process noise standard deviation yaw acceleration in rad/s^2
  std_yawdd_ = 0.30; //TODO: necessita ajustes
 ...
 * @param {VectorXd} y
*/
void UKF::GenericUpdate(const VectorXd &z, const VectorXd &y, const MatrixXd &H, const MatrixXd &R){
...
void UKF::UpdateLidar(MeasurementPackage meas_package) {
  ...
  */
  ...
  if(this->use_laser_){
    ...
    this->GenericUpdate(z, y, H_laser_, R_laser_);
  }
...
/*
*** Generate sigma points - unity 15
...
/*
*** Generate augmented sigma points - unity 18
...
/*
*** Predict mean and covariance - unity 24
...
/*
*** Predict radar measurement - unity 27
